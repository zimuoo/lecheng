...
--
-- Host: localhost    Database: xiaosaobi
-- ------------------------------------------------------
...
INSERT INTO `admin` VALUES (1,'admin','0192023a7bbd73250516f069df18b500',1,'296528828@qq.com','','13828381121','127.0.0.1',1482132862,'0',1,'/public/uploads/20191030/c6cbaa3f8be212c7bec950f885aaf920.png');
...
INSERT INTO `adsense` VALUES (1,'【底部】漂浮',1),(5,'【固定位】横幅',1);
...
INSERT INTO `category` VALUES (1,'最新动态','news','',0,2,'article','0','1,5,6,14,3',0,'最新动态','最新动态','最新动态',4,0,1,0,'',1,'','article_list','article_show',0,'1,2,3',0,0,0),(2,'关于我们','about','',0,1,'page','0','2',0,'关于我们','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。',0,0,1,0,'',0,'','','',0,'1',0,0,0),(4,'系统操作','system','',0,3,'picture','0','4',0,'CLTPHP系统操作','CLTPHP系统操作,CLTPHP,CLTPHP内容管理系统','CLTPHP系统操作,CLTPHP,CLTPHP内容管理系统',2,0,1,0,'',0,'','','',0,'1,2',0,0,0),(3,'CLTPHP服务','news','news/',1,2,'article','0,1','3',0,'产品服务-CLTPHP','产品服务,CLTPHP,CLTPHP内容管理系统','产品服务',1,0,1,0,'',0,'','','',0,'1,2,3',0,0,1),(8,'联系我们','contact','',0,1,'page','0','8',0,'联系我们','联系我们','联系我们',7,0,1,0,'',0,'','page_show_contace','page_show_contace',0,'1,2',0,0,0),(7,'精英团队','team','',0,6,'team','0','7',0,'精英团队','精英团队','精英团队',5,0,1,0,'',0,'','','',0,'1,2',0,0,0),(5,'CLTPHP动态','news','news/',1,2,'article','0,1','5',0,'CLTPHP动态','CLTPHP动态','CLTPHP动态',0,0,1,0,'',0,'','article_list','',0,'1,2,3',0,0,1),(6,'相关知识 ','news','news/',1,2,'article','0,1','6',0,'CLTPHP相关知识','CLTPHP相关知识','CLTPHP相关知识',0,0,1,0,'',0,'','','',0,'1,2,3',0,0,1),(14,'文件下载','news','news/',1,5,'download','0,1','14',0,'测试下载','测试下载','测试下载',0,0,1,0,'',0,'','','',0,'1,2,3',0,0,0);
...
INSERT INTO `links` VALUES (1,'STRJSON博客','https://strjson.com',NULL,'2168403031',1,1574396629,1);
...
INSERT INTO `module` VALUES (1,'单页模型','page','单页面',1,0,'*',0,1),(2,'文章模型','article','新闻文章',1,0,'*',0,1),(3,'图片模型','picture','图片展示',1,0,'*',0,1),(4,'产品模型','product','产品展示',1,0,'*',0,1),(5,'下载模型','download','文件下载',1,0,'*',0,1),(6,'团队模型','team','员工展示',1,0,'*',0,1);
...
CREATE TABLE `system` (
  ...
  `vod_template` varchar(64) DEFAULT NULL,
  `app_down_url` varchar(225) DEFAULT NULL,
  `ziyuan_type` varchar(10) DEFAULT NULL COMMENT '资源站类型，1普通json，2 v10资源站',
  `vod_cache_time` int(2) NOT NULL DEFAULT '24' COMMENT '数据缓存时间，小时',
  `vod_zy_list` varchar(255) DEFAULT NULL COMMENT '尝鲜资源站',
  `vod_zy_macv10` varchar(255) DEFAULT NULL COMMENT 'v10尝鲜资源站',
  `vod_jx_url` varchar(255) NOT NULL DEFAULT 'http://xz.wakoo.vip/?url=' COMMENT '视频解析地址',
  `vod_jx_yunbo_url` varchar(225) DEFAULT NULL COMMENT '云播解析地址，m3u8',
  `vod_note` varchar(225) NOT NULL DEFAULT '公告：欢迎光临乐橙影视，建议手机安装app观看，为了本站的收入，广告是必不可少的，请点击一下广告！让本站走的更远！' COMMENT '公告',
  `vod_ad_dibu` varchar(255) DEFAULT NULL COMMENT '底部漂浮代码',
  `vod_ad_hengfu` varchar(255) NOT NULL DEFAULT '<script src=''http://w.qwhtjs.com/lm.php?id=318''></script>' COMMENT '横幅广告',
  `vod_yun_config` varchar(800) DEFAULT '阿里云播%http://zy.bajieziyuan.com/inc/feifei3/%%%腾讯云播%http://www.zuidazy1.net/inc/feifei3.4/%%%百度云播%http://api.iokzy.com/inc/feifei3/%%%京东云播%https://www.mhapi123.com/inc/feifei3/' COMMENT '云播资源站',
  `vod_yun_macv10_list` varchar(800) NOT NULL DEFAULT '热播在线%https://www.rebozy.com/api.php/provide/vod/from/rem3u8/at/json/%%%速播在线%http://www.kukuzy.com/api.php/provide/vod/from/som3u8/at/json/' COMMENT 'v10云播资源站',
  `vod_tongji` varchar(255) DEFAULT NULL COMMENT '统计代码',
  `taobaoke_config` varchar(255) NOT NULL DEFAULT 'http://home.zfbma.cn' COMMENT '大淘客',
  `vod_note_color` char(64) NOT NULL DEFAULT '#fd4964' COMMENT '背景色',
  `vod_gonggao_switch` varchar(10) DEFAULT NULL COMMENT '公告开关，1开，2关',
  `vod_yunplay_switch` varchar(10) DEFAULT NULL COMMENT '云播开关，1开，2关',
...
INSERT INTO `users` VALUES (1,'1109305987@qq.com','',NULL,1,0,1516075631,0,'','','44311',0,'',NULL,NULL,'/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg',24,311,2599,0,'chichu',1,0,'','不要应为走得太远，就忘了当初为什么出发！','hide'),(2,'','e10adc3949ba59abbe56e057f20f883e',NULL,0,0,1542781390,0,'','','18092591522',1,'',NULL,NULL,NULL,0,0,0,0,'chichu',1,0,'','','hide');
...
INSERT INTO `wx_menu` VALUES (1,0,'官网','',0,2,3,'http://www.cltphp.com/',0,1,1512442512,0),(2,0,'手册','',0,2,5,'http://www.cltphp.com/',0,2,1512442543,0),(3,0,'论坛','',0,1,4,'http://bbs.cltphp.com/',0,3,1512547727,0),(4,0,'百度','',3,1,0,'http://www.baodu.com',0,1,1542783759,0);
...
INSERT INTO `wx_mp` VALUES (1,0,'WCHAT','{\"APP_KEY\":\"\",\"APP_SECRET\":\"\",\"AUTHORIZE\":\"http:\\/\\/b2c1.01.niushop.com.cn\",\"CALLBACK\":\"http:\\/\\/b2c1.01.niushop.com.cn\\/wap\\/Login\\/callback\"}','微信',0,1488350947,1497105440,''),(2,0,'SHOPWCHAT','{\"url\":\"http:\\/\\/rebo.daxwm.com\\/index\\/wechat\\/index\",\"token\":\"weixin\",\"searchUrl\":\"test.com\",\"noDataDesc\":\"\\u70b9\\u51fb\\u67e5\\u770b\\u5176\\u4ed6\\u7cbe\\u5f69\\u5f71\\u7247~\",\"noDataPic\":\"http:\\/\\/img3.doubanio.com\\/view\\/photo\\/l\\/public\\/p2546670786.jpg\"}','',1,1497088090,1573378578,NULL);
