...
class Auth extends Common
{
    ...
    public function adminAdd(){
        if(Request::isAjax()){
            ...
            return view('admin/auth/adminForm');
        }
    }
    //删除管理员
    ...
    public function adminGroup(){
        ...
        return view('admin/auth/admin_group');
    }
    //删除管理员分组
    ...
    public function groupAdd(){
        if(request()->isPost()){
            ...
            $this->assign('info','null');
            return $this->fetch('admin/auth/groupForm');
        }
    }
    //修改分组
    ...
    public function groupAccess(){
        ...
        return $this->fetch('admin/auth/group_access');
    }
    ...
    public function adminRule(){
        ...
        return view('admin/auth/admin_rule');
    }
    ...
    public function ruleAdd(){
        if(request()->isPost()){
            ...
            return $this->fetch('admin/auth/rule_add');
        }
    }
    ...
    public function ruleEdit(){
        if(request()->isPost()) {
            ...
            return $this->fetch('admin/auth/rule_edit');
        }
    }
}